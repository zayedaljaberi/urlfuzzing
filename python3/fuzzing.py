...
print('')
print('Advance Fuzzing v1.1, 2016 Development by Zayed AlJaberi')
...
def main():
    start = '''\n\nWhat are we fuzzing?\n\t1:   Automatic\n\t2:   CMS\n\t3:   WebServer\n\t4:   Others\n\t5:   Who Is Ip\n\n'''
    print (start)
    cmd_input = input("Please enter an option: ")
    if int(cmd_input) == 1:
